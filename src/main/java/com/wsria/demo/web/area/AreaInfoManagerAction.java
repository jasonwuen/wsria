package com.wsria.demo.web.area;
...
import com.wsria.arch.util.orm.EntityUtils;
...
import com.wsria.demo.service.ServiceException;
import com.wsria.demo.service.area.AreaInfoManager;
 ...
 */
@Controller
@Results( { @Result(name = CrudActionSupport.LIST, type = CrudActionSupport.JSON) })
